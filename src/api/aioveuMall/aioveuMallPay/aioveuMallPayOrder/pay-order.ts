...
const PayOrderAPI = {
    /** 获取支付订单分页数据 */
    getPage(queryParams?: PayOrderPageQuery) {
        return request<any, PageResult<PayOrderPageVO[]>>({
            url: `${PAYORDER_BASE_URL}/page`,
            method: "get",
            params: queryParams,
        });
    },
    ...
    getFormData(id: number) {
        return request<any, PayOrderForm>({
            url: `${PAYORDER_BASE_URL}/${id}/form`,
            method: "get",
        });
    },
