...
const SMSHOMEADVERT_BASE_URL = "/aioveu-tenant-sms/api/v1/sms-home-advert";

const SmsHomeAdvertAPI = {
    /** 获取首页广告配置（增加跳转路径）分页数据 */
    getPage(queryParams?: SmsHomeAdvertPageQuery) {
        return request<any, PageResult<SmsHomeAdvertPageVO[]>>({
    ...
    getFormData(id: number) {
        return request<any, SmsHomeAdvertForm>({
