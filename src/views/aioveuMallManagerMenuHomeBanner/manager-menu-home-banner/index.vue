...
import ManagerMenuHomeBannerAPI, {
  ManagerMenuHomeBannerForm,
  ManagerMenuHomeBannerPageQuery,
...
const contentConfig: IContentConfig<ManagerMenuHomeBannerPageQuery> = reactive({
  ...
  cols: [
    ...
    },
    {
      ...
      prop: "imageUrl",
      width: 300, // 增大列宽
      // height: 180, // 2. 【关键】如果有这行，一定要删掉！或者注释掉！
      templet: "image", // 使用插槽  // 使用image类型显示图片
      attrs: {
        style: "width: 250px; height: 150px; object-fit: contain;", // 增大图片尺寸
        fit: "contain", // 保持比例显示全部内容
        lazy: true, // 懒加载f
    ...
    {
      label: "状态(1:开启；0:关闭)",
      width: 150, // 增加宽度以防止内容换行 // ✅ Element UI 支持 'auto'
      showOverflowTooltip: true, // 推荐：超出宽度显示 tooltip 提示
      prop: "status",
    },
    {
