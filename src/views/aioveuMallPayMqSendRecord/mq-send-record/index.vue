...
const contentConfig: IContentConfig<MqSendRecordPageQuery> = reactive({
  ...
  cols: [
    ...
    { label: "业务ID(支付单号)", prop: "bizId" },
    { label: "业务类型:payment_success", prop: "bizType" },
    { label: "Topic", prop: "topic" },
    { label: "Tag", prop: "tag" },
    { label: "分片Key", prop: "shardingKey" },
    { label: "消息体(JSON格式)", prop: "messageBody" },
    { label: "发送状态:0-未发送,1-发送中,2-发送成功,3-发送失败", prop: "sendStatus" },
    { label: "重试次数", prop: "retryCount" },
    { label: "最大重试次数", prop: "maxRetry" },
    { label: "下次重试时间", prop: "nextRetryTime" },
