  ...
  <div class="auth-view">
    ...
    <div class="auth-view__wrapper">
      ...
      <section class="auth-feature">
        ...
        <h1 class="auth-feature__title">可我不敌可爱企业级管理系统</h1>
...
<!--        导入登录/注册/重置密码组件-->
        ...
        <footer class="auth-panel__footer">
          <el-text size="small">
            Copyright © 2021 - 2026 aioveu.com All Rights Reserved.
            <a href="http://beian.miit.gov.cn/" target="_blank">沪ICP备2025114708号</a>
          </el-text>
        </footer>
      </section>
    </div>
